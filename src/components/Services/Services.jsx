    ...
    return (
        <div className='col-11 mx-auto '>
            <div className="service-body ">
                ...
                <div className="row">
                    <div className="col-lg-8 col-sm-12 py-4 popup-ani">
                        <h1 className='text-white service-head'>We Built Best <br />Service Experience</h1>
                    </div>
                    <div className="col-lg-4 col-sm-12 popup-ani">
                    ...
                    <div className="d-flex justify-content-between align-items-center row my-sm-3 my-lg-0 service-items">
                        <div className="service-item col-lg-4 col-sm-12 popup-ani" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
